# © Patches for pyrogram/pytgcalls compatibility
# Applied before bot starts to fix missing symbols between kurigram and py-tgcalls
...
def apply():
    ...
    if not hasattr(_err, "GroupcallInvalid"):
        _err.GroupcallInvalid = _err.GroupCallInvalid  # alias: lowercase 'c'
